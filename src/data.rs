pub fn get_conf_text()->String{
    ...
    0 -Режим генерации фразы (0 последовательный перебор, 1 рандом, 2 комбинированый)\n\
    ...
    1000000 -Через сколько переборов фраз делать сохранение в файл\n\
    0 -Вывод в файл всего подбора(для отладки)\n\
    ---------------------------\n\n\

pub fn get_conf_text()->String{
    let t = "11 -Длинна сид фразы(-1, для 12 указывать 11,15=14,18=17,21=20,24=23)\n\
    satoshi,one -Начало перебора(order,cover,plug,school,clown,one,satoshi,orange,plug,female,beyond)\n\
    0 -Режим генерации фразы (0 последовательный перебор, 1 рандом, 2 комбинированный)\n\
    0 -Количество знаков последовательного перебора слева\n\
    0 -Набор случайных слов из списка(1-вкл/0-выкл)\n\
    16 -Количество случайных слов из списка\n\
    1 -Вывод (0-консоль, 1 -в файл)\n\
    1000 -Через сколько переборов фраз делать сохранение в файл\n\
    0 - перебор по словам из файла(0 -выключено,надо указать название например words.txt)\n\
    ---------------------------\n\n\
